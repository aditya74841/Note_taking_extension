...
import { Home, FileText, Folder, Link2, Tag, Edit3, Copy, Check, ExternalLink, Trash2, Eye } from 'lucide-react';
import { type Note } from '@/lib/db';
import { extractHashtags, stripAndSanitizeHtml } from '@/lib/markdown';
  ...
  return (
    <div className={`note-card ${isCurrentPage ? 'card-current' : ''}`}>
      ...
      <div className="card-snippet">
        {stripAndSanitizeHtml(note.content) || (
          <span style={{ color: '#64748b', fontStyle: 'italic' }}>No content preview available</span>
        )}
      </div>
